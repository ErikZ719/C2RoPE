...
def eval_model(args):
    ...
    for line in tqdm(questions):
        ...
        with torch.inference_mode():
            ...
            # output_ids, text_image_if = model.generate(
            #     input_ids,
            #     images=images_tensor,
            #     depths=depths_tensor,
            #     poses=poses_tensor,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--question-file", type=str,
                        default="/root/autodl-tmp/LLaVA-3D/playground/data/annotations/SQA_val.json")
    parser.add_argument("--answers-file", type=str, default="/root/autodl-tmp/LLaVA-3D/output/scanqa/test.json")
